...
///
/// It reuses the crates' permissions (boxes.*) rather than inventing a parallel set: whoever is
/// trusted to hand out and take back the market's empties is trusted with both, and a second set
/// of switches would be one more thing to get wrong on a new user.
/// </summary>
[ApiController]
[Route("api/sacks")]
[Authorize]
